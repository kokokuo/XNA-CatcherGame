...
namespace CatcherGame.TextureManager
{
    ...
    class Texture2DManager
    {
        ...
        private void LoadGameOverBackground()
        {
            ...
            {
                List<Texture2D> texture2Ds = new List<Texture2D>();
                texture2Ds.Add(mainGame.Content.Load<Texture2D>("GameOver/gameover_back"));
                _dictionary.Add(key, texture2Ds);
            }
        }
        ...
        private void LoadGameOverMenuButton()
        {
            ...
            {
                List<Texture2D> texture2Ds = new List<Texture2D>();
                texture2Ds.Add(mainGame.Content.Load<Texture2D>("GameOver/gameover_menu"));
                _dictionary.Add(key, texture2Ds);
            }
        }
        private void LoadGameOverAgainButton()
        {
            ...
            {
                List<Texture2D> texture2Ds = new List<Texture2D>();
                texture2Ds.Add(mainGame.Content.Load<Texture2D>("GameOver/gameover_again"));
                _dictionary.Add(key, texture2Ds);
            }
        }
        ...
        private void LoadGameOverCharacterShow()
        {
            ...
            {
                List<Texture2D> texture2Ds = new List<Texture2D>();
                texture2Ds.Add(mainGame.Content.Load<Texture2D>("GameOver/gameover_character_1"));
                _dictionary.Add(key, texture2Ds);
            }
        }
